...
const tiers: Tier[] = [
  {
    ...
    popular: false,
    features: [
      { text: "Custom Web Page (Basic Features)", icon: FileText },
      { text: "1-minute custom song", icon: Music },
      { text: "Acoustic/Simple arrangement", icon: Music },
      { text: "Up to 10 photo uploads", icon: Image },
      { text: "Private shareable link", icon: Check },
      { text: "3 revision rounds", icon: Check },
    ],
  ...
  },
  {
    ...
    popular: true,
    features: [
      { text: "Custom Web Page (All Features)", icon: FileText },
      { text: "Full-length custom song (3-4 min)", icon: Music },
      { text: "Studio quality arrangement", icon: Sparkles },
      { text: "Up to 50 photos & 5 videos", icon: Video },
      { text: "Private shareable link", icon: Check },
      { text: "Unlimited revisions", icon: Check },
